 ...
 * @notice Enrolls the Cardano warp route addresses as remote routers on Sepolia warp routes
 ...
 *   - EVM_SYNTHETIC_WCTEST: Sepolia wCTEST synthetic warp route address
 *   - EVM_SYNTHETIC_WADA: Sepolia wADA synthetic warp route address
 *   - EVM_COLLATERAL_FTEST: Sepolia FTEST collateral warp route address
 *   - EVM_COLLATERAL_WADA: Sepolia WADA collateral warp route address
...
contract EnrollCardanoRouters is Script {
    ...
    function run() external {
        ...
        console.log("Enrolling Cardano routers on Sepolia warp routes");
        ...
        // Read deployed Sepolia warp route addresses from environment
        ...
        // Scenario 1: Sepolia wCTEST synthetic <-> Cardano Collateral CTEST
        ...
        // Scenario 2: Sepolia FTEST collateral <-> Cardano Synthetic wFTEST
        ...
        // Scenario 3: Sepolia wADA synthetic <-> Cardano Native ADA
        ...
        // Scenario 5: Sepolia WADA collateral <-> Cardano Native ADA (alternative to scenario 3)
        ...
        console.log(
            "\n=== Sepolia routers enrolled with Cardano addresses ==="
        );
    }

    /**
     * @notice Enroll a single Cardano router on a specific Sepolia warp route
     * @dev Useful for enrolling routers one at a time or for routes not covered by run()
     *
     * Required environment variables:
     *   - EVM_SIGNER_KEY: Private key for Sepolia transactions
     *   - EVM_WARP_ROUTE: Sepolia warp route address to enroll on
    ...
    function enrollSingle() external {
        ...
        address sepoliaWarpRoute = vm.envAddress("EVM_WARP_ROUTE");
        bytes32 cardanoRouter = vm.envBytes32("CARDANO_ROUTER");

        console.log("Enrolling single Cardano router");
        console.log("Sepolia Warp Route:", sepoliaWarpRoute);
        console.log("Cardano Domain:", cardanoDomain);
        ...
        HypERC20(sepoliaWarpRoute).enrollRemoteRouter(
            cardanoDomain,
            cardanoRouter
        );
